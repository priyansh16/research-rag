...
for ingestion, retrieval, and observability. Each domain is independently 
...
| Generation (planned) | Ollama + LangChain | Local LLM for grounded response generation |
...
- 16+ Pytests testing retrieval and ingestion logic

### In Progress
- Generation layer via Ollama for local LLM inference
